    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <div style={{ width: "100%" }}>
              <Form.Item name="package_name" style={{ marginBottom: "21px" }}>
                <Input
                  size="large"
                  style={{
                    border: "none",
            ...
            <div style={{ width: "100%" }}>
              ...
              <Form.Item name="package_price" style={{ marginBottom: "24px" }}>
                <Input
                  size="large"
                  style={{
                    width: "100%",
            ...
            <div style={{ width: "100%" }}>
              ...
              >
                How many products seller add
              </label>
              <Form.Item name="products_count" style={{ marginBottom: "24px" }}>
                <Input
                  size="large"
                  style={{
                    width: "100%",
                  ...
                  <>
                    {fields.map((field, index) => (
                      <Form.Item
                        ...
                        key={field.key}
                        initialValue={
                          initialFormValues?.features[index]?.feature
                        }
                        className="w-full"
                      >
                        <Form.Item
